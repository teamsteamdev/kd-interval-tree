...
const createSearchTrees = trees => {
  const searchTrees = fp.curry((operator, ranges) => {
...
var func$4 = convert_1('flatten', flatten_1, _falseOptions);

func$4.placeholder = placeholder;
var flatten$1 = func$4;
...
var func$5 = convert_1('map', map_1);
