 ...
 * // => [2, 1]
 */
var union$1 = _baseRest(function(arrays) {
  return _baseUniq(_baseFlatten(arrays, 1, isArrayLikeObject_1, true));
});

var union_1 = union$1;

var func$1 = convert_1('union', union_1);
...
var func$2 = convert_1('intersection', intersection_1);

func$2.placeholder = placeholder;
var intersection = func$2;
...
var func$3 = convert_1('flowRight', flowRight_1);

func$3.placeholder = placeholder;
var flowRight = func$3;
...
var func$5 = convert_1('chunk', chunk_1);
...
var func$6 = convert_1('difference', difference_1);

func$6.placeholder = placeholder;
var difference = func$6;
...
var func$7 = convert_1('flatten', flatten_1, _falseOptions);

func$7.placeholder = placeholder;
var flatten$1 = func$7;
...
var func$8 = convert_1('map', map_1);
...
var func$9 = convert_1('uniqWith', uniqWith_1);
...
var getRanges = curry(function (rangeKeys, item) {
  var flatKeys = flatten$1(rangeKeys);
...
var getAdjacent = curry(function (searchTrees, item) {
  ...
  var composed = compose(searchTrees(intersection), expandRanges(Math.min), getRanges(keys));
...
var getClusters = function getClusters(sets) {
  var uniteIfIntersect = callIfLength(intersection, union);
...
exports.kdIntervalTree = kdIntervalTree;
exports.getGroupsFromKD = getGroups;
